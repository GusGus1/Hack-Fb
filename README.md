...
def loginSC():
	...
	if username =="PAGELARAN" and password =="ARMY":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/Aws Kapten.B')
				menu()
